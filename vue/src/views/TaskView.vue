...
<!--      <el-input style="width: 200px" placeholder="请输入" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:9090/taskView/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="teaName" label="昵称"></el-table-column>
      ...
      <el-table-column prop="stuName" label="昵称"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="120px" size="small" style="width: 80%; margin: 0 auto">
        ...
        <el-form-item label="昵称">
          <el-input v-model="form.teaName" autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    load() {
      this.request.get("/taskView/page", {
        params: {
    ...
    save() {
      this.request.post("/taskView", this.form).then(res => {
        if (res.code === '200') {
    ...
    del(id) {
      this.request.delete("/taskView/" + id).then(res => {
        if (res.code === '200') {
    ...
    delBatch() {
      ...
      this.request.post("/taskView/del/batch", ids).then(res => {
        if (res.code === '200') {
    ...
    exp() {
      window.open("http://localhost:9090/taskView/export")
    },
